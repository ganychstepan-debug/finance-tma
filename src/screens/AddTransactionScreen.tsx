      ...
      <div className="px-5 pt-3 pb-2 flex justify-between items-center">
        ...
        {type === 'expense' ? (
          <button
            ...
            disabled={scanning}
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-accent/10 border border-accent/50 text-accent text-sm font-semibold cursor-pointer disabled:opacity-50"
            style={{ boxShadow: '0 0 16px rgba(var(--c-accent-glow-strong), 0.35)' }}
          >
