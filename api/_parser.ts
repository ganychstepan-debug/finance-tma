...
- currency — ВНИМАТЕЛЬНО определяй валюту из текста:
  * "$", "долларов", "доллара", "баксов", "usd" → USD
  * "€", "евро", "eur" → EUR
  * "₸", "тенге", "kzt" → KZT
  * "byn", "белруб", "бр" → BYN
  * "uah", "гривен", "гривна" → UAH
  * "чф", "франков", "chf" → CHF
  * "₾", "лари", "gel" → GEL
  * "aed", "дирхам" → AED
  * "₹", "рупий", "inr" → INR
  ...
  * "¥", "юаней", "cny" → CNY
  * "₽", "руб", "рубл" → RUB
  * Если валюта не указана явно — ставь "RUB" как дефолт
...
"20 долларов за игру" → {"operations":[{"amount":20,"type":"expense","categoryGuess":"Развлечения","merchant":"","currency":"USD","comment":"игра","daysAgo":0,"confidence":"high"}]}

"обед 15€" → {"operations":[{"amount":15,"type":"expense","categoryGuess":"Еда","merchant":"","currency":"EUR","comment":"обед","daysAgo":0,"confidence":"high"}]}

"супермаркет 5000 тенге" → {"operations":[{"amount":5000,"type":"expense","categoryGuess":"Еда","merchant":"супермаркет","currency":"KZT","comment":"","daysAgo":0,"confidence":"high"}]}

"зарплата 80к и кофе 5$" → {"operations":[
  {"amount":80000,"type":"income","categoryGuess":"Зарплата","merchant":"","currency":"RUB","comment":"","daysAgo":0,"confidence":"high"},
  {"amount":5,"type":"expense","categoryGuess":"Еда","merchant":"кофе","currency":"USD","comment":"кофе","daysAgo":0,"confidence":"high"}
]}
